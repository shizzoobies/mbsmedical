  ...
  <div class="container">
    <div class="page-hero-grid">
      <div class="page-hero-text">
        ...
        <p class="lead">Clinically supervised weight management with a licensed provider, a personalized care plan, and regular follow-ups to keep your progress on track.</p>
      ...
      <div class="page-hero-img">
        <img src="<?php echo $img; ?>/weight-loss.png" alt="Medical weight loss support and telehealth consultation" />
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="split">
      <div class="split-text">
        ...
        <p>Losing weight isn&rsquo;t just about willpower. For many people, underlying factors (hormones, metabolism, medication, and lifestyle) play a significant role. MBS Medical takes a clinical-first approach: evaluate first, then build a plan that fits your health history and your goals.</p>
